...
pub fn inSet(input_bytes: v.u8x16, bitmap_0_07: v.u8x16, bitmap_8_15: v.u8x16) v.u8x16 {
    const lower = @splat(16, @as(u8, 0b0000_1111));
    ...
    const mask: v.u8x16 = simd.cmplt8_m128(hi_nibbles, @splat(16, @as(u8, 8)));
...
pub fn inSetNoBlend(input_bytes: v.u8x16, bitmap_0_07: v.u8x16, bitmap_8_15: v.u8x16) v.u8x16 {
    ...
    const msblo_nibbles = simd.and_m128(input_bytes, @splat(16, @as(u8, 0b1000_1111)));
