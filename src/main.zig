...
pub fn main() void {
    ...
    std.debug.print("\nindices_0_7 {b}\n", .{@as([16]u8, indices_0_7)});
    std.debug.print("indices_8_15 {b}\n", .{@as([16]u8, indices_8_15)});
    std.debug.print("\nindices_0_7 {x}\n", .{std.fmt.fmtSliceHexLower(&@as([16]u8, indices_0_7))});
    std.debug.print("indices_8_15 {x}\n", .{std.fmt.fmtSliceHexLower(&@as([16]u8, indices_8_15))});
